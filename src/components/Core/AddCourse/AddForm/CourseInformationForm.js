    ...
    >
      ...
      <div className="flex justify-end gap-x-2">
        ...
        <IconBtn
          ...
          customClasses={`px-5 py-2 text-center rounded-md transition-all duration-200 hover:scale-95
        bg-yellow-50 text-black hover:shadow-sm hover:shadow-brown-25 flex items-center gap-1 font-semibold`}
        >
          <MdNavigateNext />
        </IconBtn>
      </div>
